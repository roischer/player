...
admanager.view.AdView = (function(superClass) {
  ...
  AdView.prototype.start = function() {
    ...
    if (this.ad) {
      ...
      this._sendTracking("adRemainingTime", this.ad.getAdRemainingTime());
      this._remaininTimeInterval = setInterval(this._sendAdRmainingTime, 1000);
    }
    this._startTimer();
  ...
  AdView.prototype.stop = function() {
    clearInterval(this._remaininTimeInterval);
    this.stopped = true;
    this._stopTimer();
  ...
  AdView.prototype._sendAdRmainingTime = function() {
    return this._sendTracking("adRemainingTime", this.ad.getAdRemainingTime());
  };
...
admanager.view.VpaidView = (function(superClass) {
  ...
  function VpaidView(manager, config1) {
    ...
    this._onAdStoppableStateChange = bind(this._onAdStoppableStateChange, this);
    ...
    this.sendAdSize = !this.manager.config.data.noSize;
    this.video = this.manager.config.videoTag;
  ...
  VpaidView.prototype.resize = function(width, height) {
    width = this.sendAdSize ? width : null;
    height = this.sendAdSize ? height : null;
  ...
  VpaidView.prototype._display = function() {
    ...
    this._addListeners();
    this._initAd();
    return this._sendTracking("adIcon", ~~(this.ad.getAdIcons()));
  };
  ...
  VpaidView.prototype._initAd = function() {
    ...
    width = this.sendAdSize ? this.video.width : null;
    height = this.sendAdSize ? this.video.height : null;
  ...
  VpaidView.prototype._onAdVolumeChange = function(event) {
    var currVolume;
    currVolume = this.ad.getAdVolume();
    if (currVolume !== this.prevVolume) {
      this._sendTracking("getVolume", currVolume.toFixed(2));
    }
    if (currVolume === 0) {
      this._sendTracking("mute");
    } else {
    ...
    return this.prevVolume = currVolume;
  };
  ...
  VpaidView.prototype._onAdStoppableStateChange = function() {
    return this._sendTracking("stopStateChange");
  };

  VpaidView.prototype._onAdSizeChange = function() {
    this._sendTracking("adSizeChange");
    this._sendTracking("adWidth", this.ad.getAdWidth());
    return this._sendTracking("adHeight", this.ad.getAdHeight());
  };
  ...
  VpaidView.prototype._getVpaidEvents = function() {
    return {
      ...
      "AdStoppableStateChange": this._onAdStoppableStateChange,
